...
int main()
{
    ...
    std::ifstream fp("TestingData.txt");
    std::ifstream lpout("lpout.txt");
    finaloutput.open("finaltestingoutput.txt", std::ofstream::out | std::ofstream::trunc);
    finaloutput.close();
    finaloutput.open("finaltestingoutput.txt", std::ios_base::app);
